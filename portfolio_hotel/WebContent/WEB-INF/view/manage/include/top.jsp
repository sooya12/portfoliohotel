  			...
  			<ul class="menu">
				...
				<li><a href="<%=request.getContextPath()%>/manage/room/index" class="parent"><span>객실관리</span></a>
					...
					<ul>
						...
						<li><a href="<%=request.getContextPath()%>/manage/room/res/list"><span>객실예약목록</span></a></li>
					</ul>
					</div>
				</li>
				...
				<li><a href="<%=request.getContextPath()%>/manage/pkg/index" class="parent"><span>패키지관리</span></a>
					<div class="standard_left">
					<ul>
