        ...
        <div class="qna_q">
            ...
            <div class="qna_q-table">
                <div class="qna_q-box">
                    	...
                    	<ul class="base_info clear">
                            <li>
                                <label for="">카테고리</label>
                               	<select name="category" style="height:30px;" value="<%=CodeUtil.getCategory_name(qdata.getCategory()) %>">
									<option value="1" ${data.category == 1 ? "selected" : "" }> 예약 </option>
									<option value="2" ${data.category == 2 ? "selected" : "" }> 멤버쉽 </option>
									<option value="3" ${data.category == 3 ? "selected" : "" }> 기타 </option>
								</select>
                            </li>
                            <li>
                        ...
                        <ul class="base_info clear">
                            <li>
                                <label for="qna-title">이름</label>
                               		<input type="text" style="width:100px;height:45px;" id="familyname" name="lastName" value="<%=qdata.getLastName()%>" title="성을 입력해주세요" placeholder="성"></input>	
									<input type="text" style="width:150px;height:45px;" id="firstname" name="firstName" value="<%=qdata.getFirstName()%>" title="이름을 입력해주세요" placeholder="이름"></input>
                                 
                            </li>
                            <li>
                                <label for="qna-title">연락처</label>
                                <input type="text" style="width:100px;height:45px;" id="tel1" name="tel1"  title="연락처를 입력해주세요" value="<%=qdata.getTel1()%>"/>	
								<input type="text" style="width:100px;height:45px;" id="tel2" name="tel2"  title="연락처를 입력해주세요" value="<%=qdata.getTel2()%>"/>	
								<input type="text" style="width:100px;height:45px;" id="tel3" name="tel3"  title="연락처를 입력해주세요" value="<%=qdata.getTel3()%>"/>	
                            </li>
                        </ul>
                        <label for="">이메일</label>
						...
						<label for="">제목</label>
                       		<input type="text" id="title" name="title" style="width:894px;height:45px;border: 2px solid #eee;" title="제목을 입력해주세요" value="<%=qdata.getTitle()%>"/>	
                        ...
                        <label for="">내용</label>
                        	...
                        	<textarea name="contents" id="contents" 
    								...
    								color: #454545;font-family: 'Noto Sans KR', sans-serif;font-weight: 300;letter-spacing: 0.5px;"><%=qdata.getContents()%></textarea>
                       ...
                       <!--  <ul class="base_info clear">
                        ...
                        <div class="btn">
                       		<div class="btnLeft">
								<input type="submit" class="btns" href="javascript:$('#frm').submit();" value="저장"/> 
						...
						<input type="hidden" id="regdate" name="regdate" value="<%=qdata.getRegdate() %>" />
