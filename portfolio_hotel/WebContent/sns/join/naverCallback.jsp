...
String redirectURI = URLEncoder.encode("http://hyeon012.cafe24.com/sns/join/naverCallback.jsp", "UTF-8");
String apiURL;
...
$(function() {
	$.ajax({
		...
		data : {
			l_name : "<%=(String)resJson.get("name")%>",
			email : "<%=(String)resJson.get("email")%>",
			sns_key : "<%=(String)resJson.get("id")%>",
			gender : "<%="M".equals((String)resJson.get("gender")) ? "1":"2"%>",
			sns_type : "1"
		},
		dataType : "HTML",
